...
colors:
  elite-jet-black:
    value: "#1D1D1D"
    usage: "Elite Gold page/background canvas across all pages."
  elite-carbon:
    value: "#171717"
    usage: "Elite Gold cards, popups, modals, and elevated translucent surfaces."
  elite-deep-black:
    value: "#000000"
    usage: "Depth-only color for shadows, overlays, vignette fades, and modal backdrops; not the main page canvas."
  elite-note: "Project override: keep backgrounds Jet Black and Carbon-first. Do not introduce gold accents until explicitly requested; navbar, navbar effect, and sidebar remain preserved from the existing implementation."
  primary: "#fcfdff"
  primary-on: "#000000"
  ink: "#fcfdff"
