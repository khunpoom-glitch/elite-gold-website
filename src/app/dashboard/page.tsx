...
export default async function DashboardPage({ searchParams }: DashboardPageProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-6xl">
      <div className="overflow-hidden rounded-[1.45rem] border border-white/9 bg-[#1b1b1a] shadow-[0_28px_90px_rgba(0,0,0,0.42)]">
        ...
        <div className="grid gap-5 bg-[#1d1d1c] p-4 sm:p-6">
